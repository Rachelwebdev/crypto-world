...
- **Fetch numeric data from API and render on the screen per category**
- **Naviagte to details page when user clicks on a category item**
...
```sh
  cd my-folder
  git clone git@github.com:Rachelwebdev/react-capstone.git
```
...
Feel free to check the [issues page](https://github.com/Rachelwebdev/react-capstone/issues).
...
I would like to thank all my Microverse partners.
